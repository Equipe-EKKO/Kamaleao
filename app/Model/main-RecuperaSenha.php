...
function recebeEmailRecPost(string $email):bool { # define que os parametros a serem passados devem ter tipo primitivo como string, lembrando que os valores passados serão os posts estabelecidos no controller
